...
function renderMessages(inventory) {
  let messages = inventory.items;
...
function refreshMessages() {
  ...
  contract.getItems({ accountId: accountId })
    .then(renderMessages)
    .catch(console.log);
}
...
async function init() {
  ...
  contract = await near.loadContract("metanear", {
    viewMethods: ["getItems"],
