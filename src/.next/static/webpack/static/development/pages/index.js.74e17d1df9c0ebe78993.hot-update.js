...
function (_React$Component2) {
  ...
  function Game(props) {
    ...
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee() {
      var accountId, walletAccount, near;
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              accountId = walletAccount.getAccountId();
              walletAccount = new nearlib.WalletAccount(contractId, "https://wallet.nearprotocol.com/");
              near = new nearlib.Near(new nearlib.NearClient("alice.near", new nearlib.LocalNodeConnection("https://studio.nearprotocol.com/devnet")));
              _context.next = 5;
...
//# sourceMappingURL=index.js.74e17d1df9c0ebe78993.hot-update.js.map