...
function (_React$Component) {
  ...
  function Grid() {
    ...
    return Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__["default"])(Grid).apply(this, arguments));
  }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Grid, [{
    ...
    value: function componentDidMount() {
      ...
      for (var i = 0; i < this.props.width / this.props.cellWidth; ++i) {
        ...
        ctx.lineTo(i * this.props.cellWidth, this.props.cellHeight);
        ctx.stroke();
      }

      for (var _i = 0; _i < this.props.cells.length; ++_i) {
        ctx.fillRect(centerX + (this.props.cells[_i].location.x - 0.5) * this.props.cellWidth, centerY + (this.props.cells[_i].location.y - 0.5) * this.props.cellHeight, this.props.cellWidth, this.props.cellHeight);
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=index.js.f78906a90ad7f26af48b.hot-update.js.map