  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Cells, [{
    ...
    value: function componentDidMount() {
      ...
      for (var i = 0; i < this.props.cells.length; ++i) {
        ctx.fillRect(centerX + (this.props.cells[i].location.x - 0.5) * this.props.cellWidth, centerY + (this.props.cells[i].location.y - 0.5) * this.props.cellHeight, centerX + (this.props.cells[i].location.x + 0.5) * this.props.cellWidth, centerY + (this.props.cells[i].location.y + 0.5) * this.props.cellHeight);
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=index.js.d34546be0a0b4643e445.hot-update.js.map