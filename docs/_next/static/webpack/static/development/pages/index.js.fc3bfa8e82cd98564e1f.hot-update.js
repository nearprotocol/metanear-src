...
var locationKey = function locationKey(location) {
  return _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_10___default()(location);
};
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Grid, [{
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      ...
      for (var _i = 0; _i < this.props.width / this.props.cellWidth; ++_i) {
        ctx.beginPath();
        ctx.moveTo(_i * this.props.cellWidth, 0);
        ctx.lineTo(_i * this.props.cellWidth, this.props.height);
        ctx.stroke();
      }

      for (var _i2 = 0; _i2 < this.props.height / this.props.cellHeight; ++_i2) {
        ctx.beginPath();
        ctx.moveTo(0, _i2 * this.props.cellHeight);
        ctx.lineTo(this.props.width, _i2 * this.props.cellHeight);
        ctx.stroke();
      }

      this.props.cells.forEach(function (cell) {
        ctx.fillStyle = ["#FF9999", "#FFFF99", "#FF99FF", "#9999FF"][cell.viewIndex];
        ctx.fillRect(cell.location.x * _this2.props.cellWidth, _this2.props.cells[i].location.y * _this2.props.cellHeight, _this2.props.cellWidth, _this2.props.cellHeight);
      });
      ctx.beginPath();
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("canvas", {
        ref: "canvas",
...
function (_React$Component2) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(WalletLogin, [{
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("h2", null, " Hello stranger! Who are you?"), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
        id: "login-form"
...
function (_React$Component4) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_8__["default"])(MiniGameView, _React$Component4);

  function MiniGameView() {
    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_3__["default"])(this, MiniGameView);

    return Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_5__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__["default"])(MiniGameView).apply(this, arguments));
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(MiniGameView, [{
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("iframe", {
        src: this.props.url
      });
    }
  }]);
...
function (_React$Component5) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_8__["default"])(Game, _React$Component5);
  ...
  function Game(props) {
    ...
    _this3 = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_5__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__["default"])(Game).call(this, props));

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this3), "nearConnect",
    /*#__PURE__*/
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this3), "onHighlight", function (x, y) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this3), "login", function () {
      _this3.walletAccount.requestSignIn(contractId, appTitle, baseUrl + '/', baseUrl + '/');
    });

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this3), "logout", function () {});

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this3), "movePlayer", function () {
      var dx = 0;
      var dy = 0;
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Game, [{
    ...
    value: function render() {
      ...
      if (this.walletAccount && this.walletAccount.isSignedIn()) {
        control = react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(WalletLogout, {
          accountId: this.walletAccount.getAccountId(),
          onClick: this.logout
        });
      } else {
        control = react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(WalletLogin, {
          onClick: this.login
        });
      }
      ...
      if (this.state.player) {
        for (var _i3 = 0; _i3 < this.state.cells.length; ++_i3) {
          if (this.state.cells[_i3].location.x == this.state.player.location.x && this.state.cells[_i3].location.y == this.state.player.location.y) {
            cell = this.state.cells[_i3];
            break;
          }
        }

        console.log("I'm in " + _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_10___default()(this.state.player) + _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_10___default()(cell));
      }

      return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", null, control, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(Grid, {
        width: 640,
        height: 425,
        cellWidth: 20,
        cellHeight: 20,
      ...
      }), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", null, "Highlighted cell: ", _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_10___default()(this.state.highlighCell)), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", null, "Player: ", _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_10___default()(this.state.player)), cell && react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(MiniGameView, {
        url: cell.webUrl,
...
function Index() {
  return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(next_server_head__WEBPACK_IMPORTED_MODULE_13___default.a, null, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("script", {
    src: "https://cdn.jsdelivr.net/npm/nearlib@0.4.2/dist/nearlib.js"
  })), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(Game, null)));
}

/***/ })

})
//# sourceMappingURL=index.js.fc3bfa8e82cd98564e1f.hot-update.js.map