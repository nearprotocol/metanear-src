  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(Grid, [{
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      ...
      for (var _i = -cellNumberY; _i < cellNumberY; ++_i) {
        ctx.beginPath();
        ctx.moveTo(0, centerY + (_i - 0.9) * this.props.cellHeight);
        ctx.lineTo(this.props.width, centerY + (_i - 0.9) * this.props.cellHeight);
        ctx.stroke();
      }
...
//# sourceMappingURL=index.js.bb126c6d785d2c79bdfe.hot-update.js.map