...
var cellOffsets = function cellOffsets(i) {
  if (_offsetCache.length == 0) {
    for (var _dy = -viewDistance; _dy <= viewDistance; ++_dy) {
      for (var _dx = -viewDistance; _dx <= viewDistance; ++_dx) {
        _offsetCache.push({
          dx: _dx,
          dy: _dy
        });
...
function (_React$Component5) {
  ...
  function Game(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_11__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this3), "onHighlight", function (x, y) {
      ...
      if (highlightCell != _this3.state.highlightCell) {
        _this3.setState({
          ...
          movePath: _this3.calculatePath(x, y)
        });
      }
    });
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_11__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this3), "calculatePath", function (x, y) {
      ...
      var add = function add(st) {
        if (locationKey(st) in visited) {
          return;
        }

        visited[locationKey(st)] = st;
      };

      var st = {
        x: _this3.state.player.location.x,
        y: _this3.state.player.location.y,
        dist: 0
      };
      visited[locationKey(st)] = st;
      q.push(st);
...
//# sourceMappingURL=index.js.e7570072bbf45e7bd7ca.hot-update.js.map