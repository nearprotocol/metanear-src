    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this2), "movePlayer", function () {
      ...
      _this2.contract.move({
        ...
        function () {
          ...
          /*#__PURE__*/
          _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee2(player) {
            var view;
    ...
    value: function render() {
      ...
      if (this.state.player) {
        for (var i = 0; i < this.state.cells; ++i) {
          if (this.state.cells[i].location.x == this.player.location.x && this.state.cells[i].location.y == this.player.location.y) {
            cell = this.state.cells[i];
            break;
          }
        }

        console.log("I'm in " + _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(this.player.location) + _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(cell));
      }
...
//# sourceMappingURL=index.js.a86fd2ce5b84856885fa.hot-update.js.map