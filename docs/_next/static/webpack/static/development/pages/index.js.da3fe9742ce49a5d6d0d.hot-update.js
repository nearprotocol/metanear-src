...
var grassColor = function grassColor(a) {
  return "rgb(".concat(Math.round(124 * a), ", ").concat(Math.round(252 * a), ", 0)");
};
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_6__["default"])(Grid, [{
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      ...
      _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_4___default()(this.props.allCells).forEach(function (cell) {
        ...
        ctx.fillStyle = [grassColor(0.4), grassColor(0.3), grassColor(0.2), grassColor(0.1), "#883333"][cell.viewIndex];
...
function (_React$Component5) {
  ...
  function Game(props) {
    ...
    _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(window.localStorage).forEach(function (key) {
...
//# sourceMappingURL=index.js.da3fe9742ce49a5d6d0d.hot-update.js.map