...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(Grid, [{
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      ...
      var cellNumber = this.props.width / 2;

      for (var i = -this.props.width / 2 / this.props.cellWidth; i < this.props.width / 2 / this.props.cellWidth; ++i) {
        ctx.beginPath();
      ...
      for (var _i = -this.props.height / 2 / this.props.cellHeight; _i < this.props.height / 2 / this.props.cellHeight; ++_i) {
        ctx.beginPath();
        ctx.moveTo(0, centerY + _i * this.props.cellHeight);
        ctx.lineTo(this.props.width, centerY + _i * this.props.cellHeight);
        ctx.stroke();
      }
...
//# sourceMappingURL=index.js.dc97690808b1be69a3ea.hot-update.js.map